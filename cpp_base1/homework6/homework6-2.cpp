 ...
 * intput: choice
 * output: win or loss
 * describe:this program is play the game whici is connect four
 * *********************************************************/
...
// this funcation read user typing and put them on board
...
//this function is check win
int checkWin(char *board)
{
	return (horizontalCheck(board) || verticalCheck(board) || diagonalCheck(board));
}

//this function is check is it connect four
int checkFour(char *board, int a, int b, int c, int d)
{
	return (board[a] == board[b] && board[b] == board[c] && board[c] == board[d] && board[a] != ' ');
}

// This function can chekc horizontal connect
int horizontalCheck(char *board)
{
	int row, col, idx;
        const int WIDTH = 1;
...
// this  function is check vertival connect
int verticalCheck(char *board)
{
	int row, col, idx;
	const int HEIGHT = 7;
...
//this function is check oblique connect
int diagonalCheck(char *board)
{
...
//read user input and play again
